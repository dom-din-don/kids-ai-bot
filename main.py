...
inline_btn_2 = InlineKeyboardButton('Публичный репозиторий с исходниками бота', url="https://github.com/dom-din-don/kids-ai-bot")
...
@dp.message_handler(regexp='(^прив|здрав|👋|🙋)')
